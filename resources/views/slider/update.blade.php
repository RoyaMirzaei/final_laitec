...
@section('content')
    <section dir="rtl">
        ...
        <section class="container" style="padding: 50px" dir="rtl">
            ...
            <section class="form-group img-thumbnail" >
                <img src="{{asset('images/slider/'.$slider->image)}}" style="width: 50px;height: 50px">
            </section>
            ...
            <section class="form-group">
                <a href="{{route('Slider.index')}}"><input type="button" class="form-control btn btn-success" style="font-size: 15px;font-family: Tahoma" value="بازگشت به لیست تصاویر"></a>
            </section>
        </section>
    </section>
@endsection
