    ...
    <section dir="rtl">
        ...
        <section class="container" style="padding: 50px" dir="rtl">
            ...
            <section class="form-group">
                ...
                {!! Form::select('subject',['علمی'=>'علمی','فرهنگی'=>'فرهنگی','هنری'=>'هنری','تکنولوزی'=>'تکنولوزی'],$gallery->subject,['class' => 'form-control']) !!}
            </section>
            <section class="form-group">
            ...
            <section class="form-group img-thumbnail" >
                <img src="{{asset('images/gallery/'.$gallery->image)}}" style="width: 50px;height: 50px">
            </section>
